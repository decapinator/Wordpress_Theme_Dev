...
function moshi_enqueue_scripts() {
	...
	wp_enqueue_style( 'easy-autocomplete-themes', get_stylesheet_directory_uri() . '/css/easy-autocomplete.themes.css');
	wp_enqueue_style( 'animate-css', get_stylesheet_directory_uri() . '/css/animate.min.css' );
	wp_enqueue_script( 'wp-jquery.easy-autocomplete', get_template_directory_uri() . '/js/wp-jquery.easy-autocomplete.js', array(), '1.0.0', true );
