              ...
              <?php do_action( 'woocommerce_checkout_before_order_review' ); ?>
               ...
               <div id="order_review" class="woocommerce-checkout-review-order">
				...
				<div class="woocommerce-checkout-acceptable-waste">
					...
					<p>Owning to environmental obligations, we can only accept certain waste products in output_reset_rewrite_varsskip bins. The following is what can and cannot be accepted. Please call +961 70 04 08 10 for
						further assistance or enquiries.</p>
						<ul>
						...
						<ul class="not-allowed">
							...
							<li><i class="fa fa-check-circle"></i>Hardie Products</li>
						</ul>
				</div>
			</div>
		</div>
